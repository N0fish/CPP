...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/04 14:55:10 by algultse          #+#    #+#             */
/*   Updated: 2024/12/05 16:43:10 by algultse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name) : _name(name.empty() ? "robot" : name),
									_hitPoints(10),
									_energyPoints(10),
									_attackDamage(0) {
